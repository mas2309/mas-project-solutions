...
impl IDocumentoRepository for DocumentoRepository {
    async fn create(&self, dto: CreateDocumentoDto, archivo_url: &str, nombre_archivo: &str) -> Result<Documento> {
        ...
        let row = sqlx::query_as::<_, (i32, String, Option<String>, String, String, String, Option<chrono::NaiveDate>, chrono::NaiveDateTime)>(
            r#"
            INSERT INTO personal.documentos (nombre, descripcion, categoria, archivo_url, nombre_archivo, fecha_vencimiento, fecha_creacion)
    ...
    async fn find_by_id(&self, id: i32) -> Result<Option<Documento>> {
        let row = sqlx::query_as::<_, (i32, String, Option<String>, String, String, String, Option<chrono::NaiveDate>, chrono::NaiveDateTime)>(
            "SELECT id, nombre, descripcion, categoria, archivo_url, nombre_archivo, fecha_vencimiento, fecha_creacion FROM personal.documentos WHERE id = $1"
        )
        .bind(id)
    ...
    async fn list_all(&self, page: u32, page_size: u32) -> Result<(Vec<Documento>, i64)> {
        ...
        let rows = sqlx::query_as::<_, (i32, String, Option<String>, String, String, String, Option<chrono::NaiveDate>, chrono::NaiveDateTime)>(
            "SELECT id, nombre, descripcion, categoria, archivo_url, nombre_archivo, fecha_vencimiento, fecha_creacion FROM personal.documentos ORDER BY fecha_creacion DESC LIMIT $1 OFFSET $2"
        )
        ...
        let count: (i64,) = sqlx::query_as("SELECT COUNT(*) FROM personal.documentos")
    ...
    async fn delete(&self, id: i32) -> Result<Option<Documento>> {
        let row = sqlx::query_as::<_, (i32, String, Option<String>, String, String, String, Option<chrono::NaiveDate>, chrono::NaiveDateTime)>(
            "DELETE FROM personal.documentos WHERE id = $1 RETURNING id, nombre, descripcion, categoria, archivo_url, nombre_archivo, fecha_vencimiento, fecha_creacion"
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
